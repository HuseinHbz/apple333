...
The security review is not a production approval until the test guard, Prisma
deployment, real persistence tests, and CI run successfully against the
isolated target. No credentials, database URLs, or private keys belong in this
repository.
