  ...
  return (
    <main className="grid min-h-screen place-items-center bg-[#f7f7f5] px-5 py-10">
      <section className="w-full max-w-md rounded-3xl border border-zinc-200 bg-white p-7 shadow-[0_22px_70px_rgba(0,0,0,0.08)] sm:p-9">
        ...
        <h1 className="text-3xl font-semibold tracking-tight text-zinc-950">ورود به Apple333</h1>
        <p className="mt-3 text-sm leading-6 text-zinc-600">مشتریان و کاربران پنل با حساب فعال خود وارد می‌شوند؛ دسترسی هر بخش همچنان براساس نقش ثبت‌شده کنترل می‌شود.</p>
